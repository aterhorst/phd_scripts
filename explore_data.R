...
lo <- create_layout(idea_network_case_2, layout = "nicely")

p1 <- ggraph(tacit_network_case_2, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
...
p2 <- ggraph(explicit_network_case_2, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
...
p3 <- ggraph(idea_network_case_2, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
...
lo <- create_layout(idea_network_case_3, layout = "nicely")

p1 <- ggraph(tacit_network_case_3, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
...
p2 <- ggraph(explicit_network_case_3, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
...
p3 <- ggraph(idea_network_case_3, layout = "manual", node.position = lo) +
  geom_edge_link(aes(color = log1p(distance)), arrow = arrow(length = unit(2, "mm"), type = "closed")) +
  geom_node_point(aes(size = ev_brokerage, color = factor(org_affiliation))) +
  geom_node_text(aes(label = id), size = 2) +
  theme_graph() +
